    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">No. of blog posts</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800 text-dark">
                <?php
                     $count=$connection->prepare("SELECT * FROM tblblog");
                        $count->execute();
                        $blog=$count->rowCount();
                        echo $blog; 
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">No. Mails sent</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800 text-dark">
                <?php
