...
<div class="container-fluid" data-aos="fade-up" data-aos-duration="500">
    ...
    <ol class="breadcrumb mb-4 d-block" style="margin-top: 80px;">
            <li class="breadcrumb-item active">projects Search Results</li>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
          ...
          $sql = 'SELECT * FROM tblprojects WHERE project_title LIKE :searchcriteria OR author LIKE :searchcriteria OR project_description LIKE :searchcriteria OR category LIKE :searchcriteria';
          $statement = $connection->prepare($sql);
          ...
          if(sizeof($projects) == 0){ 
           ...
           ?>
           <div class="col-md-4" id="blogs">
                 <div class="card-deck">
                      <div class="card row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        <img class="card-img-top" src="admin/uploads/<?php echo $project->image ?>" alt="Card image cap" width="272" height="300">
                        <div class="card-body text-center">
                          <h5 class="card-title"><?php echo $project->project_title ?></h5>
                          <p class="card-text">Author: <?php echo $project->author ?></p>
                          
                          <p class="card-text mb-3">Category: <?php echo $project->category ?></p>
                        ...
                        <div class="card-footer w-100 text-center">
                          <small class="text-muted">Last updated <?php echo $project->PostingDate ?></small>
                        </div>
                      </div>
                  </div>
            </div>
